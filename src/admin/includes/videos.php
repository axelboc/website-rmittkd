<section id="videos" class="section box">
	...
	<div class="section-content lh">
		...
		<form class="form form--wider row" action="/core/forms/form-admin.php?feature=videos" method="post">
			<?php 
				if (isset($_SESSION['feature']) && $_SESSION['feature'] === 'videos') {
			...
			<div class="form-row row">
				...
				<div class="form-field-wrap">
					<input id="video-1" name="video-1" class="form-field box" type="url" value="<?php Videos::url(0); ?>" size="55" required>
					<div class="form-error">Enter a valid URL</div>
				</div>
			</div>
			<div class="form-row row">
				<label class="form-label" for="video-2">video #2</label>
				<div class="form-field-wrap">
					<input id="video-2" name="video-2" class="form-field box" type="url" value="<?php Videos::url(1); ?>" size="55" required>
					<div class="form-error">Enter a valid URL</div>
				</div>
			</div>
