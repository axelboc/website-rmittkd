...
<div class="body-wrap">
	...
	<article class="main row" role="main">
		<div class="body-max">
			<img class="social-hero hero respimg-fit" src="images/hero/hero-social.png" width="331" height="303" alt="">
		</div>
				...
				<div class="section-content row">
					<section class="box">
						...
						<ul class="res-list list-reset links-inv links-blend row">
							<li class="resource box"><a class="res-link" href="http://www.itftkd.org/" target="_blank"><img src="images/social/logo-itf.png" width="120" height="120" alt=""> International Taekwon-Do Federation (ITF)</a></li>
							<li class="resource box"><a class="res-link" href="http://www.aaitf.org.au/" target="_blank"><img src="images/social/logo-aaitf.png" width="120" height="120" alt=""> All Australia International Taekwon-Do Federation (AAITF) Inc.</a></li>
						</ul>
					</section>
					<section class="box">
