			...
			<div class="row">
				<div class="lay-main">
					<section id="instructors" class="instructors section">
						...
						<div class="instr-profiles car-container row" data-position="1">
							<section class="instr-profile car-slide row" aria-hidden="true">
						...
						<div class="instr-controls">
							<button class="instr-arrow instr-arrow--prev car-prev hidden-text">Previous instructor</button>
							<button class="instr-dot car-dot hidden-text" aria-selected="false">First instructor</button>
							<button class="instr-dot car-dot hidden-text" aria-selected="true">Second instructor</button>
							<button class="instr-dot car-dot hidden-text" aria-selected="false">Third instructor</button>
