...
<head>
	...
	<meta name="description" content="Learn about our club, and meet our experienced instructors and the lively members of our executive committee.">
	<meta property="og:type" content="article">
	<meta property="og:title" content="Our Dojang | RMIT ITF Taekwon-Do">
	<meta property="og:description" content="Learn about our club, and meet our experienced instructors and the lively members of our executive committee.">
						...
						<div class="instr-content section-content">
							<div class="instr-profiles">
								<section class="instr-profile hidden" tabindex="-1" aria-hidden="true">
									...
									<div class="instr-caption">
										...
										<p class="lh">Grand Master Lai (9th degree) received his first degree Black Belt in <strong>1966</strong>. Before moving to Australia, he began teaching in <strong>Malaysia</strong> where he established many clubs, totalising over 1000 members. Grand Master Lai is now a retired <abbr title="Physical Education">PE</abbr> teacher and the president of <strong><abbr title="Chan Hun International Taekwon-Do Federation">CHITF</abbr> Australia</strong>.</p>
									</div>
								</section>
							...
							<div class="instr-controls-wrap box">
								<ol class="instr-controls list-reset row">
									...
									<li><a class="instr-dot instr-dot-selected hidden-text" href="#" aria-selected="true">Second instructor</a></li>
									<li><a class="instr-dot hidden-text" href="#" aria-selected="false">Third instructor</a></li>
									<li><a class="instr-arrow instr-arrow-next hidden-text" href="#" aria-disabled="false">Next instructor</a></li>
								</ol>
							</div>
						</div>
					</section>
