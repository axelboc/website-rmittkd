...
<aside class="sidebar lay-side box backdrop" role="complementary">
	<div class="sidebar-inner">
		...
		<p><a href="<?php echo $item->link; ?>" target="_blank"><img class="merch-image respimg-fit lazy-loading" src="" data-src="images/merchandising/<?php echo $item->image['filename']; ?>" width="<?php echo $item->image['width']; ?>" height="<?php echo $item->image['height']; ?>" alt=""></a></p>
